            ...
            begin
               ...
               when Current_Tag_Def.Tag_Id.Registry =>
                  if Tag_Name = XML_Tag_Comment then
                     declare
                        Comment : not null Vk_XML.Comment_Tag.Ptr := new Vk_XML.Comment_Tag.T;
                     ...
                     declare
                        Vendor_Ids_V : not null Vk_XML.Vendor_Ids_Tag.Ptr := new Vk_XML.Vendor_Ids_Tag.T;
                     ...
                     declare
                        Tags_V : not null Vk_XML.Tags_Tag.Ptr := new Vk_XML.Tags_Tag.T;
                     ...
                     declare
                        Types_V : not null Vk_XML.Types_Tag.Ptr := new Vk_XML.Types_Tag.T;
                     ...
                     declare
                        Enums_V : not null Vk_XML.Enums_Tag.Ptr := new Vk_XML.Enums_Tag.T;
                     ...
                     declare
                        Commands_V : not null Vk_XML.Commands_Tag.Ptr := new Vk_XML.Commands_Tag.T;
                     ...
                     declare
                        Feature_V : not null Vk_XML.Feature_Tag.Ptr := new Vk_XML.Feature_Tag.T;
                     ...
                     declare
                        Extensions_V : not null Vk_XML.Extensions_Tag.Ptr := new Vk_XML.Extensions_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Vendor_Ids =>
                  if Tag_Name = XML_Tag_Vendor_Id then
                     declare
                        Vendor_Id_V : not null Vk_XML.Vendor_Id_Tag.Ptr := new Vk_XML.Vendor_Id_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Tags =>
                  if Tag_Name = XML_Tag_Tag then
                     declare
                        Tag_V : not null Vk_XML.Tag_Tag.Ptr := new Vk_XML.Tag_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Type_T =>
                  if Tag_Name = XML_Tag_Name then
                     ...
                     declare
                        Member_V : not null Vk_XML.Member_Tag.Ptr := new Vk_XML.Member_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Member =>
                  if Tag_Name = XML_Tag_Type then
                     ...
                     declare
                        Enum_V : not null Vk_XML.Enum_Tag.Ptr := new Vk_XML.Enum_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Validity =>
                  if Tag_Name = XML_Tag_Usage then
                     declare
                        Usage_V : not null Vk_XML.Usage_Tag.Ptr := new Vk_XML.Usage_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Enums =>
                  if Tag_Name = XML_Tag_Enum then
                     declare
                        Enums_Enum_V : not null Vk_XML.Enums_Enum_Tag.Ptr := new Vk_XML.Enums_Enum_Tag.T;
                     ...
                     declare
                        Unused_V : not null Vk_XML.Unused_Tag.Ptr := new Vk_XML.Unused_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Commands =>
                  if Tag_Name = XML_Tag_Command then
                     declare
                        Command_V : not null Vk_XML.Command_Tag.Ptr := new Vk_XML.Command_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Command =>
                  if Tag_Name = XML_Tag_Proto then
                     declare
                        Proto_V : not null Vk_XML.Proto_Tag.Ptr := new Vk_XML.Proto_Tag.T;
                     ...
                     declare
                        Param_V : not null Vk_XML.Param_Tag.Ptr := new Vk_XML.Param_Tag.T;
                     ...
                     declare
                        Parameters_V : not null Vk_XML.Implicit_External_Sync_Parameters_Tag.Ptr := new Vk_XML.Implicit_External_Sync_Parameters_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Feature =>
                  if Tag_Name = XML_Tag_Require then
                     declare
                        Require_V : not null Vk_XML.Require_Tag.Ptr := new Vk_XML.Require_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Require =>
                  if Tag_Name = XML_Tag_Type then
                     ...
                     declare
                        Enum_V : not null Vk_XML.Require_Enum_Tag.Ptr := new Vk_XML.Require_Enum_Tag.T;
                     ...
                     declare
                        Command_V : not null Vk_XML.Require_Command_Tag.Ptr := new Vk_XML.Require_Command_Tag.T;
               ...
               when Current_Tag_Def.Tag_Id.Extensions =>
                  if Tag_Name = XML_Tag_Extension then
                     declare
                        Extension_V : not null Vk_XML.Extension_Tag.Ptr := new Vk_XML.Extension_Tag.T;
         ...
         begin
            ...
            when Current_Tag_Def.Tag_Id.Vendor_Id =>
               if Attribute_Name = XML_Tag_Vendor_Id_Attribute_Name then
                  Current_Tag_V.Vendor_Id_V.Set_Name (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Vendor_Id_Attribute_Id then
                  Current_Tag_V.Vendor_Id_V.Set_Id (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Vendor_Id_Attribute_Comment then
                  Current_Tag_V.Vendor_Id_V.Set_Comment (Attribute_Value);
               else
            ...
            when Current_Tag_Def.Tag_Id.Type_T =>
               if Attribute_Name = XML_Tag_Type_Attribute_Name then
                  ...
                  Current_Tag_V.Type_V.Set_Comment (Attribute_Value);
               else
                  Initialize (Call_Result, GNAT.Source_Info.Source_Location & ", found unexpected attribute name ");
               end if;
            when Current_Tag_Def.Tag_Id.Member =>
               if Attribute_Name = XML_Tag_Member_Attribute_Optional then
                  ...
                  Current_Tag_V.Member_V.Set_Len (Attribute_Value);
                  ...
                  Current_Tag_V.Member_V.Set_Valid_Extension_Structs (Attribute_Value);
               else
                  Initialize (Call_Result, GNAT.Source_Info.Source_Location & ", found unexpected attribute name ");
               end if;
            when Current_Tag_Def.Tag_Id.Enums =>
               if Attribute_Name = XML_Tag_Enums_Attribute_Name then
                  Current_Tag_V.Enums_V.Set_Name (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Enums_Attribute_Comment then
                  Current_Tag_V.Enums_V.Set_Comment (Attribute_Value);
            ...
            when Current_Tag_Def.Tag_Id.Enums_Enum =>
               if Attribute_Name = XML_Tag_Enums_Enum_Attribute_Value then
                  Current_Tag_V.Enums_Enum_V.Set_Value (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Enums_Enum_Attribute_Name then
                  Current_Tag_V.Enums_Enum_V.Set_Name (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Enums_Enum_Attribute_Comment then
                  Current_Tag_V.Enums_Enum_V.Set_Comment (Attribute_Value);
            ...
            when Current_Tag_Def.Tag_Id.Unused =>
               if Attribute_Name = XML_Tag_Unused_Attribute_Start then
                  Current_Tag_V.Unused_V.Set_Start (Attribute_Value);
               else
                  Initialize (Call_Result, GNAT.Source_Info.Source_Location & ", found unexpected attribute name ");
               end if;
            when Current_Tag_Def.Tag_Id.Command =>
            ...
            when Current_Tag_Def.Tag_Id.Param =>
               if Attribute_Name = XML_Tag_Param_Attribute_Optional then
                  ...
                  Current_Tag_V.Param_V.Set_External_Sync (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Param_Attribute_Len then
                  Current_Tag_V.Param_V.Set_Len (Attribute_Value);
            ...
            when Current_Tag_Def.Tag_Id.Require_Enum =>
               if Attribute_Name = XML_Tag_Require_Enum_Attribute_Name then
                  ...
                  Current_Tag_V.Require_Enum_V.Set_Dir (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Require_Enum_Attribute_Extends then
                  Current_Tag_V.Require_Enum_V.Set_Extends (Attribute_Value);
               elsif Attribute_Name = XML_Tag_Require_Enum_Attribute_Comment then
                  Current_Tag_V.Require_Enum_V.Set_Comment (Attribute_Value);
            ...
            when Current_Tag_Def.Tag_Id.Require_Command =>
               if Attribute_Name = XML_Tag_Require_Command_Attribute_Name then
                  Current_Tag_V.Require_Command_V.Set_Name (Attribute_Value);
               else
                  Initialize (Call_Result, GNAT.Source_Info.Source_Location & ", found unexpected attribute name ");
               end if;
            when Current_Tag_Def.Tag_Id.Extension =>
               if Attribute_Name = XML_Tag_Extension_Attribute_Name then
                  Current_Tag_V.Extension_V.Set_Name (Attribute_Value);
         ...
         begin
            if Find_Tag_Call_Result.Exists then
               ...
               begin
                  ...
                  case Current_Tag_V.Kind_Id is
                  when Current_Tag_Def.Tag_Id.Comment =>
                     Current_Tag_V.Comment.Set_Value (Tag_Value);
                  when Current_Tag_Def.Tag_Id.Type_T =>
                     declare
                  ...
                  when Current_Tag_Def.Tag_Id.Name =>
                     Current_Tag_V.Name_V.Set_Value (Tag_Value);
                  when Current_Tag_Def.Tag_Id.Nested_Type =>
                     Current_Tag_V.Nested_Type_V.Set_Value (Tag_Value);
                  when Current_Tag_Def.Tag_Id.Usage =>
                     declare
                        XML_Text_V : not null Vk_XML.String_Ptr := new Aida.String_T'(Tag_Value);
                  ...
                  when Current_Tag_Def.Tag_Id.Enum =>
                     Current_Tag_V.Enum_V.Set_Value (Tag_Value);
                  when Current_Tag_Def.Tag_Id.External_Sync_Parameter =>
                     Current_Tag_V.External_Sync_Parameter_V.Set_Value (Tag_Value);
                  when Current_Tag_Def.Tag_Id.Registry |
                       Current_Tag_Def.Tag_Id.Vendor_Ids |
                       Current_Tag_Def.Tag_Id.Vendor_Id |
                       Current_Tag_Def.Tag_Id.Tags |
