...
package Win32 is
  ...
  subtype Str_16_Unbound is Ada.Strings.Wide_Unbounded.Unbounded_Wide_String;
  subtype Str_8_Unbound  is Ada.Strings.Unbounded.Unbounded_String;
  subtype Str_16_C       is Interfaces.C.WChar_Array;
  subtype Str_16         is Wide_String;
  subtype Str_C          is Str_16_C;

  -- Integers
  type Int_Ptr              is mod System.MEMORY_SIZE;
  type Int_8_Percent        is range 1..100; for Int_8_Percent'Size use 8;
  subtype Int_8_Unsigned    is Interfaces.Unsigned_8;
  ...
  subtype Int_16_Unsigned   is Interfaces.Unsigned_16;
  ...
  subtype Int_32_Unsigned   is Interfaces.Unsigned_32;
  ...
  subtype Int_64_Unsigned   is Interfaces.Unsigned_64;
  ...
  -- Stream types
--  subtype Array_Stream is Ada.Streams.Stream_Element_Array;

  -- Access types
  subtype Ptr                is System.Address;
  type Ptr_Ptr               is access all System.Address;
...
--  NULL_STR_C    : constant Str_C   := NULL_STR_16_C;
  NULL_PTR      : constant Ptr     := System.NULL_ADDRESS;
   ...
   type WNDCLASSEX is record
      ...
      lpfnWndProc   : System.Address        := NULL_PTR; -- WNDPROC   
