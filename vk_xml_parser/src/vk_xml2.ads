...
package Vk_XML2 is
   ...
   package Tag is
      ...
      package Z is
         ...
         type Const_Name_Ptr is access constant Name_T;

         type Author_T is new Ada.Strings.Unbounded.Unbounded_String;

         type Const_Author_Ptr is access constant Author_T;

         type Contact_T is new Ada.Strings.Unbounded.Unbounded_String;

         type Const_Contact_Ptr is access constant Contact_T;

      end Z;

      type T is limited private;

      function Name (This : T) return Z.Const_Name_Ptr;

      function Author (This : T) return Z.Const_Author_Ptr;

      function Contact (This : T) return Z.Const_Contact_Ptr;
   ...
   private
      ...
      type T is limited
         record
            My_Name    : aliased Z.Name_T;
            My_Author  : aliased Z.Author_T;
            My_Contact : aliased Z.Contact_T;
         end record;

      function Name (This : T) return Z.Const_Name_Ptr is (This.My_Name'Unchecked_Access);

      function Author (This : T) return Z.Const_Author_Ptr is (This.My_Author'Unchecked_Access);

      function Contact (This : T) return Z.Const_Contact_Ptr is (This.My_Contact'Unchecked_Access);
